    ...
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-line rounded-lg text-sm font-medium text-ink hover:bg-line/20 disabled:opacity-50 disabled:cursor-not-allowed transition-colors mb-4"
        >
          {oauthLoading === 'google' ? (
        ...
        <div className="relative mb-4">
          ...
          <div className="relative flex justify-center text-xs text-muted">
            <span className="bg-paper px-3">or sign in with email</span>
          </div>
        </div>
