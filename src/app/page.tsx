      ...
      <section className="w-full bg-paper relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 max-md:py-16">
          <div className="max-w-3xl">
            ...
            <h1 className="text-[clamp(2.2rem,5vw,3.8rem)] font-bold text-ink leading-[1.08] tracking-tight mb-5">
              Independent Equity Research &amp; Valuation Insights
            </h1>
            <p className="text-[clamp(1rem,1.8vw,1.2rem)] text-muted max-w-[580px] leading-relaxed mb-9">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/research"
                className="inline-flex items-center justify-center gap-2 min-h-[48px] px-6 bg-ink text-paper rounded-lg font-bold text-[0.95rem] hover:-translate-y-0.5 transition-all"
              >
              ...
              <Link
                href="/about"
                className="inline-flex items-center justify-center min-h-[48px] px-6 border border-ink text-ink rounded-lg font-bold text-[0.95rem] hover:-translate-y-0.5 transition-all"
              >
                About Aadith
              </Link>
            </div>
      ...
      <section className="w-full bg-paper border-t border-line">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="flex items-end justify-between mb-8">
            <div>
              <p className="text-accent font-extrabold text-[0.78rem] tracking-[0.08em] uppercase mb-2">
                Latest
              </p>
            ...
            <Link
              href="/research"
              className="inline-flex items-center gap-1 text-[0.88rem] text-muted font-semibold hover:text-ink transition-colors border-b border-transparent hover:border-ink pb-0.5"
            >
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      {m.sector && (
                        <span className="text-[0.72rem] text-muted font-semibold">{m.sector}</span>
                      )}
                    </div>
                    {m.rating && (
                      <span className={`text-[0.72rem] font-black uppercase tracking-[0.06em] px-2.5 py-0.5 rounded-full ${ratingStyle}`}>
                        {m.rating}
                      </span>
                    )}
                  </div>
                  ...
                  {/* Title */}
                  <h3 className="text-[1rem] font-bold text-ink mb-2 leading-snug group-hover:text-accent transition-colors flex-1">
                    {post.title}
                  </h3>
                  ...
                  <div className="pt-4 border-t border-line flex items-center justify-between">
                    ...
                    <span className="text-[0.82rem] text-accent font-bold inline-flex items-center gap-1">
      ...
      <section className="w-full bg-paper border-t border-line">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 max-md:py-14">
          <div className="max-w-[520px] mb-12">
            <p className="text-accent font-extrabold text-[0.78rem] tracking-[0.08em] uppercase mb-3">
              Approach
            </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {PHILOSOPHY.map(({ icon: Icon, title, body }) => (
              <div key={title} className="bg-panel border border-line rounded-xl p-6 hover:border-accent/30 transition-colors">
                ...
                <h3 className="text-[0.95rem] font-bold text-ink mb-2">{title}</h3>
          ...
          <div className="max-w-[480px]">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 min-h-[48px] px-6 border border-ink text-ink rounded-lg font-bold text-[0.95rem] hover:-translate-y-0.5 transition-all"
              >
